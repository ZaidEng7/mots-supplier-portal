...
public static class AdminSeeder
{
    ...
    // Identity policy here is length>=12, no complexity requirement (Program.cs) - kept simple to
    // type live rather than adding punctuation/case-mixing nothing actually enforces.
    public const string Password = "motsadmin2026";
...
/// in-product path creates staff users, so this goes through UserManager directly.
///
...
public static class ReviewerSeeder
{
    ...
    public const string Password = "motsreview2026";
