...
export const Input = forwardRef<HTMLInputElement, InputProps>(function Input(
  ...
  return (
    <input
      ...
      className={`w-full rounded-[var(--radius-md)] px-3 py-2 text-[length:var(--text-body)] outline-none transition-colors duration-[var(--motion-fast)] ease-[var(--ease-out)] ${className}`}
      style={{
