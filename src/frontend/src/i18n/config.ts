  ...
  ar: {
    translation: {
      ...
      contacts: {
        ...
        errors: { fullNameRequired: 'الاسم الكامل مطلوب', emailInvalid: 'البريد الإلكتروني غير صحيح', removeFailed: 'تعذر الحذف' },
      },
      addresses: {
  ...
  en: {
    translation: {
      ...
      contacts: {
        ...
        errors: { fullNameRequired: 'Full name is required', emailInvalid: 'Enter a valid email', removeFailed: 'Could not remove' },
      },
      addresses: {
