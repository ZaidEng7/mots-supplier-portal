...
const resources = {
 ...
 home: 'الرئيسية', dashboard: 'لوحة التحكم', onboarding: 'استكمال الملف', profile: 'ملف الشركة', documents: 'المستندات', proposals: 'عروضي', account: 'حسابي', offerings: 'الخدمات المعروضة', team: 'الفريق', settings: 'الإعدادات', backOffice: 'الإدارة الداخلية', logout: 'تسجيل الخروج', mobileTabBarLabel: 'التنقل الرئيسي', rfqs: 'طلبات العروض' },
      supplierDashboard: {
        ...
        proposals: 'عروضي',
        awards: 'نتائج الترسية',
        awardsEmpty: 'لم تُحسم أي من عروضك بعد.',
      ...
      apiKeys: {
        ...
        subtitle: 'بيانات اعتماد تستخدمها أنظمة أخرى لقراءة تغذيات البيانات. لا تصلح لتسجيل دخول شخص.',
        createTitle: 'إصدار مفتاح',
        createHelp: 'المفتاح يقرأ تغذيات الموردين وطلبات العروض فقط، وتنتهي صلاحيته بعد سنة.',
        name: 'الاسم',
        nameHint: 'اسم يوضّح النظام الذي سيستخدمه، مثل «لوحة معلومات الوزارة».',
        create: 'إصدار',
        createFailed: 'تعذّر إصدار المفتاح',
        issuedTitle: 'المفتاح الجديد',
        issuedWarning: 'انسخ المفتاح الآن. لا يحتفظ النظام بنسخة منه ولن يُعرض مرة أخرى؛ إن فُقد يجب إصدار مفتاح بديل.',
        copy: 'نسخ',
        ...
        revokeFailed: 'تعذّر إلغاء المفتاح',
        none: 'لا توجد مفاتيح بعد.',
        loadFailed: 'تعذّر تحميل المفاتيح',
      ...
      procurementDashboard: {
        ...
        taskKinds: {
          ...
          ClarificationClosing: 'إغلاق باب الاستيضاح',
          BidValidityExpiring: 'انتهاء صلاحية العرض',
        },
      ...
      onboarding: {
        ...
        optionalHint: 'اختياري. لا يمنع تقديم الطلب.',
        gateProgressLabel: 'تقدّم استكمال الطلب',
        gateOutstandingLabel: 'ما تبقّى',
        readOnlyTitle: 'طلبك لدى المراجع',
        readOnlyApprovedTitle: 'تمت الموافقة على طلبك',
        readOnlyApprovedBody: 'الشاشة للقراءة فقط بعد صدور القرار.',
        readOnlyRejectedTitle: 'لم يُقبل طلبك',
        readOnlyRejectedBody: 'الشاشة للقراءة فقط بعد صدور القرار.',
        readOnlyGenericTitle: 'الشاشة للقراءة فقط',
        readOnlyGenericBody: 'لا يمكن تعديل أي شيء هنا حالياً.',
        titleReadOnly: 'ملف شركتك',
        readOnlyBody: 'الشاشة للقراءة فقط ما دام الطلب لديه. إذا لزم تصحيح، سيطلبه المراجع، وتُفتح عندها الحقول التي يذكرها وحدها.',
        ...
        stepStatus: {
          complete: 'مكتملة',
          optional: 'اختيارية',
          left_one: 'بقي عنصر واحد',
          left_two: 'بقي عنصران',
          left_few: 'بقي {{count}} عناصر',
          left_many: 'بقي {{count}} عنصراً',
          left_other: 'بقي {{count}} عنصر',
        },
        fields: {
        ...
        errors: {
          legalNameArRequired: 'الاسم القانوني (عربي) مطلوب',
          legalNameEnRequired: 'الاسم القانوني (إنجليزي) مطلوب',
          establishedInFuture: 'لا يمكن أن يكون تاريخ التأسيس في المستقبل.',
        },
        ...
        infoRequestedItems: 'البنود المطلوب تعديلها:',
        ...
        termsCheckboxLabel: 'أوافق على الشروط والأحكام وسياسة معالجة البيانات الخاصة ببوابة الموردين.',
        termsPending: 'لم تنشر الوزارة هذه الوثيقة بعد. تُسجَّل موافقتك الآن، وستظهر الوثيقة في صفحة «عن البوابة» فور صدورها.',
        termsAccept: 'موافقة',
      ...
      addresses: {
        ...
        errors: {
          ...
          latitudeRange: 'حدّد موقع العنوان على الخريطة، أو اكتب خط عرض بين -٩٠ و٩٠ بنقطة عشرية',
          longitudeRange: 'حدّد موقع العنوان على الخريطة، أو اكتب خط طول بين -١٨٠ و١٨٠ بنقطة عشرية',
          nameArRequired: 'اسم الفرع (عربي) مطلوب',
          nameEnRequired: 'اسم الفرع (إنجليزي) مطلوب',
          removeFailed: 'تعذر الحذف',
        },
        mapHint: 'اضغط على الخريطة لتحديد موقع العنوان، أو اسحب الدبوس لضبطه. يمكنك أيضاً كتابة الإحداثيات مباشرة.',
        mapLabel: 'خريطة لتحديد موقع العنوان',
      },
      banking: {
      ...
      proposal: {
        ...
        backToTender: 'الرجوع إلى صفحة المناقصة',
        submit: 'إرسال العرض',
 ...
 home: 'Home', dashboard: 'Dashboard', onboarding: 'Complete profile', profile: 'Company profile', documents: 'Documents', proposals: 'My proposals', account: 'My account', offerings: 'Offerings', team: 'Team', settings: 'Settings', backOffice: 'Back office', logout: 'Log out', mobileTabBarLabel: 'Primary navigation', rfqs: 'Tenders' },
      supplierDashboard: {
        ...
        awards: 'Award results',
        awardsEmpty: 'None of your bids has been decided yet.',
      ...
      apiKeys: {
        title: 'API keys',
        subtitle: 'Credentials other systems use to read the data feeds. They are not sign-ins for people.',
        createTitle: 'Issue a key',
        createHelp: 'A key reads the supplier and tender feeds and nothing else, and expires after a year.',
        name: 'Name',
        nameHint: 'Name the system that will use it, for example "Ministry dashboard".',
        create: 'Issue',
        createFailed: 'Could not issue the key',
        issuedTitle: 'The new key',
        issuedWarning: 'Copy the key now. Nothing here keeps a copy and it will not be shown again - if it is lost, issue a replacement.',
        copy: 'Copy',
        copied: 'Key copied',
        dismiss: 'Hide',
        created: 'Issued',
        ...
        none: 'No keys have been issued yet.',
      ...
      procurementDashboard: {
        ...
        taskKinds: {
          ...
          ClarificationClosing: 'Clarification closing',
          BidValidityExpiring: 'Bid validity expiring',
        },
        noTasks: 'Nothing due',
      ...
      onboarding: {
        ...
        optionalHint: 'Optional. It never blocks a submission.',
        gateProgressLabel: 'Application progress',
        gateOutstandingLabel: 'What is left',
        readOnlyTitle: 'Your application is with a reviewer',
        readOnlyApprovedTitle: 'Your application has been approved',
        readOnlyApprovedBody: 'This screen is read-only now that the application is decided.',
        readOnlyRejectedTitle: 'Your application was not accepted',
        readOnlyRejectedBody: 'This screen is read-only now that the application is decided.',
        readOnlyGenericTitle: 'This screen is read-only',
        readOnlyGenericBody: 'Nothing here can be changed at the moment.',
        titleReadOnly: 'Your supplier profile',
        readOnlyBody: 'This screen is read-only while they have it. If they need a correction they will ask for one, and only the fields they name will reopen.',
        ...
        stepStatus: {
          complete: 'Complete',
          optional: 'Optional',
          left_one: '1 thing left',
          left_other: '{{count}} things left',
        },
        fields: {
        ...
        errors: {
          legalNameArRequired: 'Legal name (Arabic) is required',
          legalNameEnRequired: 'Legal name (English) is required',
          establishedInFuture: 'A founding date cannot be in the future.',
        },
        ...
        infoRequestedItems: 'The items to change:',
        resubmit: 'Resubmit',
        ...
        termsCheckboxLabel: 'I accept the Supplier Portal Terms & Conditions and data-processing notice.',
        termsPending: 'The Ministry has not published this document yet. Your acceptance is recorded now, and the document will appear on the About page once it is issued.',
        termsAccept: 'Accept',
      ...
      addresses: {
        ...
        errors: {
          ...
          latitudeRange: 'Place the address on the map, or type a latitude between -90 and 90 with a decimal point',
          longitudeRange: 'Place the address on the map, or type a longitude between -180 and 180 with a decimal point',
          nameArRequired: 'Branch name (Arabic) is required',
          nameEnRequired: 'Branch name (English) is required',
          removeFailed: 'Could not remove',
        },
        mapHint: 'Click the map to place your address, or drag the pin to adjust it. You can also type the coordinates directly.',
        mapLabel: 'Map for placing the address',
      },
      banking: {
        title: 'Bank Accounts',
      ...
      proposal: {
        ...
        backToTender: 'Back to the tender',
        ...
        withdrawWarning: 'This bid will be removed and cannot be restored. You can still start a new bid while the tender is open for submissions.',
