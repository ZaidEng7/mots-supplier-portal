...
| Components read **semantic** tokens only, never `--n-500` or `--brand-500`. Tailwind's own type, weight and shadow scales are banned too. | `src/frontend/src/styles/tokenConformance.test.ts` |
